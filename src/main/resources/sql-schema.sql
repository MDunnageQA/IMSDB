...
create table if not exists ims.orders(id int primary key auto_increment, ordersNumItems int, ordersCost double, ordersDate varchar(40), item_id int not null, customer_id int not null, foreign key(customer_id) references customers(id));